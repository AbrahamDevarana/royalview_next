...
export default function Home_Slider_1() {
    ...
    const rePositionArrows = () => {
        const bannerPicture = document.querySelector("#bannerPicture") as HTMLImageElement;
                    ...
                    <figure className="flex flex-col items-center align-middle relative pt-1">
                        ...
                        <div className="px-2 lg:px-0">
                            <Image
                                quality={100}
                                src={img_1}
                                alt="ninos-departamentos-en-venta-queretaro-2-recamaras-style-plus-1080x1080"
                                placeholder="blur"
                                width={687}
                                height={687}
                                id="bannerPicture"
                ...
                <SwiperSlide>
                    <figure className="flex flex-col items-center align-middle relative py-1">
                        ...
                        <div className="px-2 lg:px-0">
                            <Image
                                src={img_2}
                                alt="terraza-departamentos-en-venta-queretaro-2-recamaras-style-plus-1080x1080"
                                placeholder="blur"
                                width={687}
                                height={687}
                                className="rounded-3xl w-full"
                ...
                <SwiperSlide>
                    <figure className="flex flex-col items-center align-middle relative py-1">
                        ...
                        <div className="px-2 lg:px-0">
                            <Image
                                src={img_3}
                                alt="cocina-departamentos-en-venta-queretaro-2-recamaras-style-plus-1080x1080"
                                placeholder="blur"
                                width={687}
                                height={687}
                                className="rounded-3xl w-full"
                ...
                <SwiperSlide>
                    <figure className="flex flex-col items-center align-middle relative py-1">
                        ...
                        <div className="px-2 lg:px-0">
                            <Image
                                src={img_4}
                                alt="bano-departamentos-en-venta-queretaro-3-y-4-recamaras-luxury-1080x1080"
                                placeholder="blur"
                                width={687}
                                height={687}
                                className="rounded-3xl w-full"
                        ...
                        <figcaption className="max-w-[680px] pt-5">
                            ...
                            <p className="font-light text-base px-5">
                                ...
                                confort en cada pieza. Departamentos en preventa
                                y de entrega inmediata en Zibatá, Querétaro.
                            </p>
                        </figcaption>
                    </figure>
                </SwiperSlide>
                <SwiperSlide>
                    <figure className="flex flex-col items-center align-middle relative py-1">
                        ...
                        <div className="px-2 lg:px-0">
                            <Image
                                src={img_5}
                                alt="recamara-departamentos-en-venta-queretaro-3-y-4-recamaras-luxury-1080x1080"
                                placeholder="blur"
                                width={687}
                                height={687}
                                className="rounded-3xl w-full"
