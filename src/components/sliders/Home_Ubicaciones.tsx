                        ...
                        <div className="col-span-12 xl:col-span-5 flex lg:order-1 order-2">
                            <div className="max-w-md lg:py-10 flex flex-col xl:mx-0 mx-auto justify-center">
                                ...
                                <p className="font-light lg:text-left text-justify lg:text-base text-sm">
                                    Royal View se asienta en la cima de la
                                    exclusividad en Zibatá. Con departamentos
                                    cerca de todos los servicios, su ubicación
                                    es inmejorable, ofreciendo panoramas
                                    inigualables de la ciudad y la sierra
                                    queretana.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="col-span-12 xl:col-span-5 flex lg:order-1 order-2">
                            <div className="max-w-md lg:py-10 flex flex-col xl:mx-0 mx-auto justify-center">
                                ...
                                <p className="font-light lg:text-left text-justify lg:text-base text-sm">
                                    ...
                                    departamento a 4 minutos de HEB supermercado
                                    y a 5 minutos de plazas comerciales que te
                                    ofrecen servicios como taquería, cafetería,
                                    pizzería, farmacia, tiendas, entre otros.
                                </p>
                            </div>
                        </div>
                        <div className="col-span-12 xl:col-span-7 flex align-middle lg:order-2 order-1">
                        ...
                        <div className="col-span-12 xl:col-span-5 flex lg:order-1 order-2">
                            <div className="max-w-md lg:py-10 flex flex-col xl:mx-0 mx-auto justify-center">
                                ...
                                <p className="font-light lg:text-left text-justify lg:text-base text-sm">
                                    ...
                                    primer nivel. Departamentos a 5 minutos de
                                    distancia de la Univesidad Anáhuac,
                                    Querétaro. Escuelas de educación básica a 10
                                    minutos.
                                </p>
                            </div>
                        </div>
