...
export default function Amenidades() {
    ...
    const rePositionArrows = () => {
        ...
        const rightArrow = document.querySelector(
            ".amenidadesSwiper .swiper-button-next",
        ) as HTMLElement;
        const leftArrow = document.querySelector(
            ".amenidadesSwiper .swiper-button-prev",
        ) as HTMLElement;
    ...
    return (
        <>
            ...
            <div
                className="max-w-screen-xl px-10 text-center mx-auto lg:py-[140px] py-12"
                data-aos="fade-up"
                ...
                <div className="grid grid-cols-12 lg:gap-y-0 gap-y-5">
                    <div className="col-span-12 lg:col-span-5 lg:order-1 order-2">
                        <div className="max-w-md">
                            ...
                            <p className="font-light lg:text-base text-sm">
                                Descubre tu nuevo estilo de vida con más de 30
                                amenidades para ti y tu familia, para disfrutar
                                a diario con vistas panorámicas inigualables.
                            </p>
                            <p className="pt-7 pb-14 font-light lg:text-base text-sm">
                                Un proyecto extraordinario que combina las
                                mejores vistas y las amenidades más completas
                                con el sello de calidad y éxito de DEVARANA.
                            </p>
                            <div className="flex">
                                <button
                    ...
                    <div className="col-span-12 lg:col-span-7 relative lg:order-2 order-1">
                        ...
                        <IsotipoSVG
                            width={40}
                            height={40}
                            className="mx-auto absolute top-5 left-5 z-50"
                        />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className="max-w-screen-2xl mx-auto lg:px-10 px-5 pt-0 pb-16">
                    <p className="text-royal-graph text-center lg:text-base text-sm lg:py-14 py-5">
                        Los residentes de Royal View tienen acceso a las
                        amenidades de todas las torres, siguiendo los
                        lineamientos para su buen uso y conservación.
                    </p>
                        ...
                        >
                            ...
                            <SwiperSlide>
                                ...
                                <ul className="list-disc list-inside lg:text-base text-sm">
                                    ...
                                    <li className="leading-7">
                                        Salón de ejercicios múltiples
                                    </li>
                                    <li className="leading-7">Kids club</li>
                                    <li className="leading-7">
                                        Salón de eventos Fuego
                                    </li>
                                    <li className="leading-7">Motor lobby</li>
                                    <li className="leading-7">Recepción</li>
                                    <li className="leading-7">
            ...
            <div className="lg:my-0 lg:hidden block">
                <ImageText
                    image={areasVerdesResponsive}
                    text={"Amplias áreas verdes"}
                    line={false}
                />
            </div>
