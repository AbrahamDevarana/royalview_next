            ...
            <div className={`lg:py-[60px] py-[40px] flex justify-center items-center bg-royal-pearl relative flex-col lg:flex-row`}>
                ...
                <div className="flex lg:pt-0 pt-5">
                    ...
                    <div className="lg:mx-[80px] mx-[40px] relative lg:w-[40px] lg:h-[40px] w-[30px] h-[30px]">
                        <Link href={wspSend} passHref as={'https://api.whatsapp.com/send?phone=+524428244444&text=Hola, quisiera más información de Royal View.'}>
                    ...
                    <div className="lg:mr-[80px] mr-[40px] relative lg:w-[40px] lg:h-[40px] w-[30px] h-[30px]">
                        <Link href="https://goo.gl/maps/Bp2LANyebxogoSDh7" passHref as={'https://goo.gl/maps/Bp2LANyebxogoSDh7'}>
                    ...
                    <div className="lg:mr-[80px] mr-[40px] relative lg:w-[40px] lg:h-[40px] w-[30px] h-[30px]">
                        ...
                        as={'https://ul.waze.com/ul?place=ChIJywNLPDpX04URHZbTxj-wP50&ll=20.67125480%2C-100.33704070&navigate=yes&utm_campaign=default&utm_source=waze_website&utm_medium=lm_share_location'}>
