...
export default function Home_Amenidades() {
    ...
    const rePositionArrows = () => {
        ...
        const rightArrow = document.querySelector('.secondSwiper .swiper-button-next');
        const leftArrow = document.querySelector('.secondSwiper .swiper-button-prev');
    ...
    >
        <SwiperSlide className="lg:px-14 pb-12">
            <Image alt="alberca-departamentos-en-venta-queretaro-amenidades-de-lujo-1080x1080" id="firstPic"  src={img_1} width={640} height={640} />
        </SwiperSlide>
        <SwiperSlide className="lg:px-14 pb-12">
