...
const Menu = ({activeNavbar, responsiveScreen}) => {
    ...
    return ( 
        <>
            <div id="menuBar" className={`hidden lg:block fixed transition-all ease-in-out duration-500 z-10 right-0 left-0  ${activeNavbar === 1? 'top-0 bg-white shadow' : activeNavbar === 0? '-top-96' : 'top-0' }`}>
